...
@Composable
private fun _ClickableCardImpl(
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
    applyFillMaxWidth: Boolean = true,
    minHeight: Dp = 68.dp,
    shape: Shape? = null,
...
// ══════════════════════════════════════════════════════════════════════
//  PUBLIC OVERLOAD 1 — Primary (all params explicit, nullable shape)
// ══════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════
//  PUBLIC OVERLOAD 2 — With fillMaxWidth control
// ══════════════════════════════════════════════════════════════════════
...
fun ClickableCard(
    ...
    onClick = onClick,
    modifier = modifier,
    applyFillMaxWidth = fillMaxWidth,
    minHeight = minHeight,
    shape = shape,
    colors = colors,
    tonalElevation = tonalElevation,
...
// ══════════════════════════════════════════════════════════════════════
//  PUBLIC OVERLOAD 3 — With accentColor convenience
// ══════════════════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════════════════
//  InfoCard — Non-clickable card (same visual style, no press animation)
// ══════════════════════════════════════════════════════════════════════
