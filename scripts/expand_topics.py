...
ARTWORK_NAMES = [
    ...
    "Nocturne in Black and Gold: The Falling Rocket (1875) by Whistler", "A Sunday on La Grande Jatte (1886) by Georges Seurat",
    ...
    "Balloon Dog (Orange) (1994-2000) by Jeff Koons", "Cloud Gate (2006) by Anish Kapoor",
    "Sunflower Seeds (2010) by Ai Weiwei", "The Weather Project (2003) by Olafur Eliasson",
    "Infinity Mirror Room - Phalli's Field (1965) by Yayoi Kusama", "Maman (1999) by Louise Bourgeois",
