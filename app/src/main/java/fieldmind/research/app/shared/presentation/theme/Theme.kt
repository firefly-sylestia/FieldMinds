    ...
    return when (schemeName) {
        ...
        "Pastel" -> if (darkTheme) {
            darkColorScheme(
                ...
                inversePrimary = PastelInversePrimaryDark,
                surfaceDim = PastelSurfaceContainerLowestDark,
                surfaceBright = PastelSurfaceContainerHighestDark,
                surfaceContainerLowest = PastelSurfaceContainerLowestDark,
                surfaceContainerLow = PastelSurfaceContainerLowDark,
                surfaceContainer = PastelSurfaceContainerDark,
                surfaceContainerHigh = PastelSurfaceContainerHighDark,
                surfaceContainerHighest = PastelSurfaceContainerHighestDark
            )
        } else {
            lightColorScheme(
                primary = PastelPrimaryLight,
                onPrimary = PastelOnPrimaryLight,
                primaryContainer = PastelPrimaryContainerLight,
                onPrimaryContainer = PastelOnPrimaryContainerLight,
                secondary = PastelSecondaryLight,
                onSecondary = PastelOnSecondaryLight,
                secondaryContainer = PastelSecondaryContainerLight,
                onSecondaryContainer = PastelOnSecondaryContainerLight,
                tertiary = PastelTertiaryLight,
                onTertiary = PastelOnTertiaryLight,
                tertiaryContainer = PastelTertiaryContainerLight,
                onTertiaryContainer = PastelOnTertiaryContainerLight,
                error = PastelErrorLight,
                onError = PastelOnErrorLight,
                errorContainer = PastelErrorContainerLight,
                onErrorContainer = PastelOnErrorContainerLight,
                background = PastelBackgroundLight,
                onBackground = PastelOnBackgroundLight,
                surface = PastelSurfaceLight,
                onSurface = PastelOnSurfaceLight,
                surfaceVariant = PastelSurfaceVariantLight,
                onSurfaceVariant = PastelOnSurfaceVariantLight,
                outline = PastelOutlineLight,
                outlineVariant = PastelOutlineVariantLight,
                scrim = Color.Black,
                inverseSurface = PastelInverseSurfaceLight,
                inverseOnSurface = PastelInverseOnSurfaceLight,
                inversePrimary = PastelInversePrimaryLight,
                surfaceDim = PastelSurfaceContainerLowestLight,
                surfaceBright = PastelSurfaceContainerHighestLight,
                surfaceContainerLowest = PastelSurfaceContainerLowestLight,
                surfaceContainerLow = PastelSurfaceContainerLowLight,
                surfaceContainer = PastelSurfaceContainerLight,
                surfaceContainerHigh = PastelSurfaceContainerHighLight,
                surfaceContainerHighest = PastelSurfaceContainerHighestLight
            )
        }
